...
class Priority_Queue:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            if current is None:
                previous._next = _PQ_Node(value, None)
                self._rear = previous._next
            elif previous is None:
                self._front = _PQ_Node(value, current)
            else:
                previous._next = _PQ_Node(value, current)
    ...
    def _remove(self, previous, current):
        ...
        even know what happened to it. Fogettaboutit!
        """
        if previous is None:
    ...
    def _append_queue(self, source):
        ...
        if self._front is not None:
            if source._front._value > self._rear._value:
