...
#             self._set_first()
            if self._values[self._first]>key:
                ...
                if target1._first!=None:
                    if target1._values[target1._first]>target1._values[len(target1._values)-1]:
                        target1._first = len(target1._values)-1
                else:
                    target1._first = 0
            else:
                target2._values.append(deepcopy(self._values.pop(self._first)))
                if target2._first!=None:
                    if target2._values[target2._first]>target2._values[len(target2._values)-1]:
