...
class Queue:
    ...
    def combine_r(self, source1, source2):
        ...
        """
        t_one = True
        self.combine_r_aux(source1, source2, t_one)
        return

    def combine_r_aux(self, source1, source2, t_one):
        "Does all the looping work of combine_r!"
        ...
        elif source1._front is not None:
            self._move_front(source1)
            self.combine_r_aux(source1, source2, t_one)
    ...
    def split_alt_r(self):
        ...
        self.split_alt_r_aux(target1, target2, t_one)
        
        return target1, target2
        
    def split_alt_r_aux(self, t1, t2, t_one):
        "Does the recursive work of split alt r"        
        ...
        if self._front is not None:
            ...
            if t_one:
                ...
                t2._move_front(self)
            t_one = not t_one
            self.split_alt_r_aux(t1, t2, t_one)
    ...
    def is_identical_r(self, target):
        ...
        if self._count != target._count:
            ...
            if source_node is not None and source_node._value == target_node._value:
                source_node = source_node._next
                target_node = target_node._next
                source_node = self.is_identical_r_aux(source_node, target_node)
    ...
    def is_identical_r_aux(self, source_node, target_node):
        "another aux to do the work of the _r!"
